...
import { formatJaHourMinute } from "@web-speed-hackathon-2026/client/src/utils/date_time";
      ...
      <div className="bg-cax-surface-subtle flex-1 space-y-4 overflow-y-auto px-4 pt-4 pb-8">
        ...
        <ul className="grid gap-3" data-testid="dm-message-list">
          {conversation.messages.map((message) => {
            const isActiveUserSend = message.senderId === activeUser.id;
              ...
              >
                ...
                <div className="flex gap-1 text-xs">
                  <time dateTime={message.createdAt}>
                    {formatJaHourMinute(message.createdAt)}
                  </time>
