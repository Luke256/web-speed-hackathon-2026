...
import { FetcherHttpError, sendJSON } from "@web-speed-hackathon-2026/client/src/utils/fetchers";
...
function getErrorCode(err: FetcherHttpError, type: "signin" | "signup"): string {
  ...
  const handleSubmit = useCallback(
    async (values: AuthFormData) => {
      try {
        ...
        const error = getErrorCode(err as FetcherHttpError, values.type);
